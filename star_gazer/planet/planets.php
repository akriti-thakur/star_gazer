...
$sql="select*from planets where activity=1";
$result=mysqli_query($lol,$sql);
if($_SERVER['REQUEST_METHOD']=='GET'){
    if(isset($_GET['p_id'])){
    echo "<script>alert('Deleted Data');</script>";
    $p_id=$_GET['p_id'];
    $sql="UPDATE planets set activity=0 WHERE p_id='$p_id'";
    ...
    <div class="row">
        <div class="col-10">
            <div class="input-group">
                ...
                <input  name="bb" type="text" class="form form-control" placeholder="search planet....">
        ...
        <div class="col-2">
            <button class="btn btn dark" type="submit" name="submit" data-bs-toggle="modal" data-bs-target="#planetadd">
              Add New Planet
            </button>
        </div>
  </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Add planets</h1>
      ...
      <div class="col-md-6">
    <label for="username" class="form-label">Planet Name:</label>
    <input type="text" class="form-control" id="name" name="name">
  </div>
  <br>
  <div class="col-md-6">
    <label for="email" class="form-label">Planet Size:</label>
    <input type="email" class="form-control" id="size" name="size">
  </div>
  <br>
  <div class="col-md-6">
    <label for="age" class="form-label">Planet Speed:</label>
...
<br>
  <div class="col-12">
    ...
    <input type="file" class="custom-file-input" id="userphoto" name="planetimage"placeholder="">
  </div>
    ...
    <tr id="row<?= $rows['p_id'] ?>">   
     <!-- ye kyu likha -->
             <td><?php echo $rows['image'];?></td>
                ...
                <td><?php echo $rows['p_size'];?></td>
                <td><?php echo $rows['rotation_speed'];?></td>
        <td>        
      <button onclick="updateplanet(this.id)" class="mr-3 edit "style="color: #CD833a" title="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
      <a href="planet.php?p_id=<?php echo $rows['p_id'];?>" class="mr-3  delete "style="color: red" title="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
